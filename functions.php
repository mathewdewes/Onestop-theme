<?php
/**
 * mat functions and definations.
 */

if ( ! function_exists( 'matcustom_setup' ) ) {
    /**
    ...
    function mat_setup() {
		 ...
		 * to change 'mat' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'mat', get_template_directory() . '/languages' );
		...
		add_theme_support( 'custom-background', apply_filters( 'mat_custom_background_args', array(
		...
		register_nav_menus( array(
			'primary' => esc_html__( 'Primary', 'mat' ),
            'footer' => esc_html__( 'Footer Menu', 'mat' ),
            'header_action' => esc_html__( 'Header Action', 'mat' ),
		) );
 ...
 */
function mat_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'mat_content_width', 1170 );
}
add_action( 'after_setup_theme', 'mat_content_width', 0 );
 ...
 * @since 1.0.0
 */
function mat_sidebar_widgets_init() {
	// Default Sidebar
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'mat' ),
		'id'            => 'default-sidebar',
		'description'   => esc_html__( 'Add widgets here.', 'mat' ),
...
add_action( 'widgets_init', 'mat_sidebar_widgets_init' );

/**
 * Enqueue public scripts and styles.
 */
function mat_public_scripts() {
    // Styles.
...
add_action( 'wp_enqueue_scripts', 'mat_public_scripts' );

/**
 * Enqueue admin scripts and styles.
 */
function mat_admin_scripts() {

}
add_action( 'admin_enqueue_scripts', 'mat_admin_scripts' );